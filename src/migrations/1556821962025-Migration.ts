...
export class Migration1556821962025 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TYPE "events_scope_enum" AS ENUM('0', '1', '2')`);
        await queryRunner.query(`CREATE TABLE "events" ("id" SERIAL NOT NULL, "scope" "events_scope_enum" NOT NULL DEFAULT '0', "title" text NOT NULL, "isPublic" boolean NOT NULL DEFAULT false, "isActive" boolean NOT NULL DEFAULT true, "runCount" integer NOT NULL DEFAULT -1, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP DEFAULT null, "webhookUrl" text, "webhookBody" text, "userId" integer NOT NULL, "abiEventId" integer, "appId" integer, "parentId" integer, CONSTRAINT "PK_40731c7151fe4be3116e45ddf73" PRIMARY KEY ("id"))`);
