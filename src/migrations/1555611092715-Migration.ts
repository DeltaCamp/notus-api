...
export class Migration1555611092715 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TYPE "events_scope_enum" AS ENUM('0', '1', '2')`);
        await queryRunner.query(`CREATE TABLE "events" ("id" SERIAL NOT NULL, "scope" "events_scope_enum" NOT NULL DEFAULT '0', "title" text NOT NULL, "isPublic" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP DEFAULT null, "userId" integer NOT NULL, "abiEventId" integer, "appId" integer, "parentId" integer, CONSTRAINT "PK_40731c7151fe4be3116e45ddf73" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "matchers" ("id" SERIAL NOT NULL, "order" integer NOT NULL DEFAULT 1, "source" "matchers_source_enum" NOT NULL, "operator" "matchers_operator_enum" NOT NULL, "operand" text, "operandDataType" "matchers_operanddatatype_enum", "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "eventId" integer NOT NULL, "abiEventInputId" integer, CONSTRAINT "PK_84af8b70f57bbdcc106a21b31da" PRIMARY KEY ("id"))`);
