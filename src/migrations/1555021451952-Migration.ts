...
export class Migration1555021451952 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "matchers" ("id" SERIAL NOT NULL, "operator" "matchers_operator_enum" NOT NULL, "operand" text NOT NULL, "operandDataType" "matchers_operanddatatype_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "variableId" integer NOT NULL, CONSTRAINT "PK_84af8b70f57bbdcc106a21b31da" PRIMARY KEY ("id"))`);
